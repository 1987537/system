    ...
    <table border="1" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            <tr>
                ...
                <td>${user.balance}</td>
                <td>${user.phone}</td>
                <td><a href="/users/touserUpdate.action?uid=${uid}">修</a> </td>
                <td><a href="/users/userdeleteUserByUid.action?uid=${uid}">删</a></td>
                <td><a href="/users/redtopup.action?uid=${uid}">氪</a></td>
            </tr>
        </tbody>
    </table>
</div>
