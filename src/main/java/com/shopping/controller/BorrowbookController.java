...
public class BorrowbookController {
    ...
    public ModelAndView queryAllBorrow(){
        List<BorrowBook> borrowBookList=borrowbookService.queryAllBorrow();
    ...
    public ModelAndView queryTopAdmin(){
        ...
        ModelAndView mv=new ModelAndView();
        mv.addObject("rankingTop",rankingTop);
    ...
    public ModelAndView queryBorrowByUid(int uid){
        List<BorrowBook> borrowBookList=borrowbookService.queryBorrowByUid(uid);
